                            ...
                            <div className="mt-10 flex gap-4">
                                {project.id === "barangay" ? (
                                    <a
                                        ...
                                        className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3 font-medium transition hover:bg-blue-500"
                                    >
                                        Live Demo
                                    </a>
                                ) : (
                                ...
                                {project.sourceCode ? (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center rounded-xl border border-white/20 px-6 py-3 font-medium transition hover:border-blue-500 hover:bg-white/5"
                                    >
                                        View Source
                                    </a>
                                ) : (
