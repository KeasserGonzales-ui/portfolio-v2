...
const ProfileCard = () => {
    return (
        <div className="rounded-3xl border border-slate-700 bg-slate-900/60 p-5 shadow-xl backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400 hover:shadow-cyan-500/20 sm:p-8">
            <div className="flex flex-col items-center text-center">
                ...
                <div className="mb-6">
                    <img
                        ...
                        className="h-32 w-32 rounded-full border-4 border-cyan-400 object-cover shadow-xl sm:h-40 sm:w-40"
                    />
                </div>
