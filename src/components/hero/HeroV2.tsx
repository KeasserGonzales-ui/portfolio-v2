...
export default function HeroV2() {
    return (
        <section className="min-h-screen bg-[#09090B] text-white">
            <div className="mx-auto flex min-h-screen max-w-7xl flex-col items-center gap-12 px-5 py-24 sm:px-8 lg:flex-row lg:gap-8 lg:py-0">
                ...
                <div className="w-full flex-1">
                    ...
                    <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                        <a
                            href="#projects"
                            className="rounded-lg bg-blue-600 px-6 py-3 text-center font-semibold transition-all duration-300 hover:bg-blue-500"
                        >
                            View Projects
                        </a>
                        ...
                        <a
                            ...
                            download
                            className="rounded-lg border border-gray-600 px-6 py-3 text-center transition-all duration-300 hover:border-cyan-400 hover:bg-cyan-400 hover:text-black"
                        >
                            Download Resume
                        </a>
                    </div>
